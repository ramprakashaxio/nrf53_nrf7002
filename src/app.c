...
K_THREAD_DEFINE(start_http_thread_id, 10240,
		start_http_thread, NULL, NULL, NULL,
		7, 0, -1);

//_____________Toggle_LED________________________
...
// 		7, 0, 0);
//_____________Toggle_LED________________________________________________
