...
set(NRFXLIB_DIR          C:/nrf/v3.1.0/nrfxlib            CACHE STRING "nrfxlib folder")
set(NRF_SECURITY_ROOT    C:/nrf/v3.1.0/nrf/subsys/nrf_security          CACHE STRING "nrf_security root folder")
set(OBERON_PSA_CORE_PATH C:/nrf/v3.1.0/modules/crypto/oberon-psa-crypto  CACHE STRING "oberon-psa-core folder")
set(ARM_MBEDTLS_PATH     C:/nrf/v3.1.0/modules/crypto/mbedtls            CACHE STRING "Mbed TLS folder")
set(NRF_DIR              C:/nrf/v3.1.0/nrf                              CACHE STRING "NRF folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    D:/nrf-connect-ws/hr/sta/nrf52dk/sta/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      D:/nrf-connect-ws/hr/sta/nrf52dk/sta/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
